local function setup_keymaps(illuminate)
  local tools = require 'user.tools'
  tools.nvmap('<leader>ik', illuminate.goto_prev_reference, { desc = 'Illuminate: previous reference' })
  tools.nvmap('<leader>ij', illuminate.goto_next_reference, { desc = 'Illuminate: next reference' })
end
