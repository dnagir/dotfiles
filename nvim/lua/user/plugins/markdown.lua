-- Table of contents generation that is based on https://github.com/richardbizik/nvim-toc/blob/1324bb865fb446b048025514abb1e26bfe456a17/lua/nvim-toc/init.lua
-- That is MIT licensed.
-- The content is taken as-is but:
-- - reformatted according to Lua LSP.
-- - Autocmd updated to use a different user command name.
-- - Changed to use unordered list instead of numbered.

local function setup_toc()
  local M = {}
  ...
  function M.get_toc(toc)
    ...
    for _, v in pairs(toc) do
      ...
      -- orginal: line = line .. number .. ". " .. "[" .. v.title .. "](#" .. link .. ")"
      line = line .. "- " .. "[" .. v.title .. "](#" .. link .. ")"
...
return {
  ...
  -- install with yarn or npm
  {
    ...
    dependencies = {
      'nvim-treesitter', -- for the TOC generation
    },
