local function set_vcs_description_settings()
...
vim.api.nvim_create_autocmd('FileType', {
    ...
    pattern = "gitcommit",
    callback = set_vcs_description_settings
})

-- Enable spellcheck for jj decription.
vim.api.nvim_create_autocmd('FileType', {
    group = vim.api.nvim_create_augroup('UserFileTypeJJDescription', {}),
    desc = "Settings for JJDescription",
    pattern = "jj",
    callback = set_vcs_description_settings
})
